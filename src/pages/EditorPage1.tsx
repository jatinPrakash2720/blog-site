...
import type { Blog, User } from "@/types/api";
import Loader from "@/components/ui/Loader";
import { EditorProvider, useEditorContext, useEditorContextSafe } from "@/store/editor";
...
const EditorFlow: React.FC = () => {
  ...
  const { title, content, setContent, setTitle } = useEditorContextSafe();
