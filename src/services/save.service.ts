...
export const createSaveCollection = (
  data: apiInterfaces.CreateSaveCollectionPayload
) => {
  return apiClient.post<ApiResponse<apiInterfaces.SaveCollection>>(
    "/saves",
    data
  );
};
...
export const updateSaveCollection = (
  collectionId: string,
  data: apiInterfaces.UpdateSaveCollectionPayload
) => {
  return apiClient.patch<ApiResponse<apiInterfaces.SaveCollection>>(
    `/saves/${collectionId}`,
    data
  );
};
...
export const toggleBlogInCollection = (
  collectionId: string,
  blogId: string
) => {
  return apiClient.patch<
    ApiResponse<apiInterfaces.ToggleBlogInCollectionResponse>
  >(`/saves/toggle/${collectionId}/${blogId}`);
};
